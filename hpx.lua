...
Converted["_usersLabel"].TextColor3 = Color3.fromRGB(255, 255, 255)
...
Converted["_skins"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["_skins"].BackgroundTransparency = 1
Converted["_skins"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_skins"].BorderSizePixel = 0
Converted["_skins"].Position = UDim2.new(0.00286532962, 0, 0.380582511, 0)
Converted["_skins"].Size = UDim2.new(0, 170, 0, 50)
Converted["_skins"].Visible = false
Converted["_skins"].Name = "skins"
Converted["_skins"].Parent = Converted["_mainFrame"]
...
local function PSQGNHV_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.LocalScript
	...
	local vipButton = menu:WaitForChild("skinsButton")
	...
	local vip = mainFrame:WaitForChild("skins")
	...
	vipButton.MouseButton1Click:Connect(abrirskins)
	
	-- MENU PADRÃO
	abrirConfig()
end
local function HRBNO_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
    script.Parent = Converted["_mainFrame"]
    local req = require
...
local function EJFYIQ_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
    script.Parent = Converted["_mainFrame"]
    local req = require
...
local function HEOB_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
    script.Parent = Converted["_mainFrame"]
    local req = require
...
local function NMOCBK_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.configUS.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local usernameLabel = script.Parent:WaitForChild("username")
	
	usernameLabel.Text = player.DisplayName .. " ( " .. player.Name .. " )"
end
local function ZSAY_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.configUS.usersLabel.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function HNJKFF_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.configUS.pingLabel.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	pingLabel.TextStrokeTransparency = 1
...
local function WBFQWZ_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.configUS.fpsLabel.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function YXMBVRK_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.configUS.platformLabel.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local platformLabel = script.Parent
	
	platformLabel.BackgroundTransparency = 1
	platformLabel.TextStrokeTransparency = 1
...
local function HDGMKO_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.movi.AtalhosManager
    local script = Instance.new("LocalScript")
...
local function XMBS_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.movi.EspButton.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function RZZYK_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.movi.femotesButton.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local favoritos = {}
	local mostrandoFavoritos = true
	
	local saveName = "HPX_Emote_Favoritos_" .. LocalPlayer.UserId .. ".json"
	
	-- LOAD FAVORITOS
	if isfile and readfile and isfile(saveName) then
	...
	local function salvarFavoritos()
		if writefile then
			pcall(function()
				writefile(saveName, HttpService:JSONEncode(favoritos))
			end)
		end
	end
	
	-- FAVORITAR
	local function Favoritar(nome, id)
	
		id = tostring(id)
	
		if favoritos[id] then
			favoritos[id] = nil
		else
			favoritos[id] = {
				nome,
	...
	-- PANEL
	local emoteBox = Instance.new("Frame")
	emoteBox.Name = "EmotePanel"
	emoteBox.Parent = gui
	...
	favButton.Parent = topBar
	favButton.Size = UDim2.new(0,30,0,25)
	favButton.Position = UDim2.new(1,-320,0.5,-12)
	favButton.Text = "⭐"
	...
	keyButton.Parent = topBar
	keyButton.Size = UDim2.new(0,70,0,25)
	keyButton.Position = UDim2.new(1,-280,0.5,-12)
	keyButton.Text = "CTRL"
	...
	search.Size = UDim2.new(0,140,0,25)
	search.Position = UDim2.new(1,-165,0.5,-12)
	...
	grid.Parent = scroll
	grid.CellSize = UDim2.new(0,140,0,105)
	...
	local function playEmote(name, id)
		...
		local cleanName = tostring(name):gsub("⭐ ", "")
		...
		-- DELTA METHOD
		pcall(function()
			desc:AddEmote(cleanName, idNumber)
		end)
		...
		warn("Não conseguiu tocar:", cleanName, idNumber)
	end
	...
	local function createButton(name, id)
		...
		txt.Parent = btn
		txt.Size = UDim2.new(1,-30,0,22)
		txt.Position = UDim2.new(0,3,1,-25)
		...
		star.Position = UDim2.new(1,-24,1,-24)
		star.BackgroundTransparency = 1
		star.TextScaled = true
		star.Font = Enum.Font.GothamBold
		star.TextColor3 = Color3.fromRGB(255,255,0)
	
		if favoritos[idString] then
			star.Text = "⭐"
		else
			star.Text = "☆"
		end
		...
		star.MouseButton1Click:Connect(function()
			...
			if mostrandoFavoritos then
				pesquisarCatalogo(search.Text)
			end
		end)
	...
	-- SEARCH
	function pesquisarCatalogo(texto)
	
		local resultado = {}
	
		texto = string.lower(texto or "")
	
		-- FAVORITOS
		if mostrandoFavoritos then
	
			for _,info in pairs(favoritos) do
	
				if texto == "" or string.find(string.lower(info[1]), texto) then
					table.insert(resultado,info)
				end
			end
	...
	-- LOAD PLAYER EMOTES
	local function carregarEmotesDoPlayer()
		...
		if ok and desc then
			...
			local ok2, userEmotes = pcall(function()
				return desc:GetEmotes()
			end)
	
			if ok2 and userEmotes then
	
				for emoteName, ids in pairs(userEmotes) do
					...
					if typeof(ids) == "table" then
						...
						for _, id in ipairs(ids) do
							...
							if not favoritos[idString] then
								favoritos[idString] = {
									"⭐ "..emoteName,
									id
								}
	...
	favButton.MouseButton1Click:Connect(function()
		...
		mostrandoFavoritos = not mostrandoFavoritos
	...
	button.MouseButton1Click:Connect(function()
		...
		emoteBox.Visible = not emoteBox.Visible
	
		if emoteBox.Visible then
			pesquisarCatalogo(search.Text)
		end
	end)
	...
	UIS.InputBegan:Connect(function(input,gp)
		...
		if escolhendoTecla and input.KeyCode ~= Enum.KeyCode.Unknown then
...
local function RSTPED_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.movi.clicktpButton.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	UserInputService.InputBegan:Connect(function(input, gameProcessed)
		...
		if escolhendoTecla then
			if input.UserInputType == Enum.UserInputType.Keyboard then
				...
				-- remove a tecla antiga do ClickTP
				if teclaAtalho then
				...
				_G.HPX_Atalhos[teclaNova] = "ClickTP"
		...
		-- ATIVAR / DESATIVAR PELO ATALHO
		if input.UserInputType == Enum.UserInputType.Keyboard then
			if teclaAtalho and input.KeyCode == teclaAtalho then
				clickTpAtivado = not clickTpAtivado
				atualizarBotao()
			end
		end
...
local function UFZEOU_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.movi.flyButton.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function SAPQIN_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.vampiro.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local function aplicarAnimacao()
		...
		animate.idle.Animation1.AnimationId = VAMPIRO.Idle1
		animate.idle.Animation2.AnimationId = VAMPIRO.Idle2
		animate.walk.WalkAnim.AnimationId = VAMPIRO.Walk
		animate.run.RunAnim.AnimationId = VAMPIRO.Run
		animate.jump.JumpAnim.AnimationId = VAMPIRO.Jump
		animate.fall.FallAnim.AnimationId = VAMPIRO.Fall
		animate.climb.ClimbAnim.AnimationId = VAMPIRO.Climb
		animate.swim.Swim.AnimationId = VAMPIRO.Swim
		animate.swimidle.SwimIdle.AnimationId = VAMPIRO.SwimIdle
...
local function SBAIQK_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.zumbie.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local function aplicarAnimacao()
		...
		animate.idle.Animation1.AnimationId = ZOMBIE.Idle1
		animate.idle.Animation2.AnimationId = ZOMBIE.Idle2
		animate.walk.WalkAnim.AnimationId = ZOMBIE.Walk
		animate.run.RunAnim.AnimationId = ZOMBIE.Run
		animate.jump.JumpAnim.AnimationId = ZOMBIE.Jump
		animate.fall.FallAnim.AnimationId = ZOMBIE.Fall
		animate.climb.ClimbAnim.AnimationId = ZOMBIE.Climb
		animate.swim.Swim.AnimationId = ZOMBIE.Swim
		animate.swimidle.SwimIdle.AnimationId = ZOMBIE.SwimIdle
...
local function JZWQ_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.adidas.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local ADIDAS = {
		Idle1 = "rbxassetid://18537371238",
		Idle2 = "rbxassetid://18537376492",
		...
		Swim = "rbxassetid://18537398538",
		SwimIdle = "rbxassetid://18537402667"
	}
	...
	local function aplicarAnimacao()
		...
		animate.idle.Animation1.AnimationId = ADIDAS.Idle1
		animate.idle.Animation2.AnimationId = ADIDAS.Idle2
		animate.walk.WalkAnim.AnimationId = ADIDAS.Walk
		animate.run.RunAnim.AnimationId = ADIDAS.Run
		animate.jump.JumpAnim.AnimationId = ADIDAS.Jump
		animate.fall.FallAnim.AnimationId = ADIDAS.Fall
		animate.climb.ClimbAnim.AnimationId = ADIDAS.Climb
		animate.swim.Swim.AnimationId = ADIDAS.Swim
		animate.swimidle.SwimIdle.AnimationId = ADIDAS.SwimIdle
...
local function KCDM_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.Bolhoso.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	-- usando os IDs reais de animação e não os IDs do catálogo
	local BUBBLY = {
	...
	local function aplicarAnimacao()
		...
		setAnim(animate.idle.Animation1, BUBBLY.Idle1)
		setAnim(animate.idle.Animation2, BUBBLY.Idle2)
	
		setAnim(animate.walk.WalkAnim, BUBBLY.Walk)
		setAnim(animate.run.RunAnim, BUBBLY.Run)
	
		setAnim(animate.jump.JumpAnim, BUBBLY.Jump)
		setAnim(animate.fall.FallAnim, BUBBLY.Fall)
	
		setAnim(animate.climb.ClimbAnim, BUBBLY.Climb)
	
		setAnim(animate.swim.Swim, BUBBLY.Swim)
		setAnim(animate.swimidle.SwimIdle, BUBBLY.SwimIdle)
...
local function PTNVS_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.ninja.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local function aplicarAnimacao()
		...
		-- NADAR
		animate.swim.Swim.AnimationId = NINJA.Swim
...
local function WHXTO_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.lobo.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local function aplicarAnimacao()
		...
		-- IDLE
		animate.idle.Animation1.AnimationId = WEREWOLF.Idle1
		animate.idle.Animation2.AnimationId = WEREWOLF.Idle2
	
		-- MOVIMENTO
		animate.walk.WalkAnim.AnimationId = WEREWOLF.Walk
		animate.run.RunAnim.AnimationId = WEREWOLF.Run
	
		-- PULO / QUEDA
		animate.jump.JumpAnim.AnimationId = WEREWOLF.Jump
		animate.fall.FallAnim.AnimationId = WEREWOLF.Fall
	
		-- ESCALAR
		animate.climb.ClimbAnim.AnimationId = WEREWOLF.Climb
	
		-- NADAR
		animate.swim.Swim.AnimationId = WEREWOLF.Swim
		animate.swimidle.SwimIdle.AnimationId = WEREWOLF.SwimIdle
...
local function NPMUIZR_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.mago.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	-- IDs confirmados do pacote Mage
	local MAGE = {
		Idle1 = "rbxassetid://754637456",
		Idle2 = "rbxassetid://754637456",
	
		Walk = "rbxassetid://754636298",
		Run = "rbxassetid://754635032",
	
		Jump = "rbxassetid://754637084",
		Fall = "rbxassetid://754636589",
	
		Climb = "rbxassetid://754639239",
	
		Swim = "rbxassetid://754638471",
		SwimIdle = "rbxassetid://754638471"
	}
	...
	local function aplicarAnimacao()
		...
		-- IDLE
		setAnim(animate.idle.Animation1, MAGE.Idle1)
		setAnim(animate.idle.Animation2, MAGE.Idle2)
	
		-- MOVIMENTO
		setAnim(animate.walk.WalkAnim, MAGE.Walk)
		setAnim(animate.run.RunAnim, MAGE.Run)
	
		-- PULO / QUEDA
		setAnim(animate.jump.JumpAnim, MAGE.Jump)
		setAnim(animate.fall.FallAnim, MAGE.Fall)
	
		-- ESCALAR
		setAnim(animate.climb.ClimbAnim, MAGE.Climb)
	
		-- NADAR
		setAnim(animate.swim.Swim, MAGE.Swim)
		setAnim(animate.swimidle.SwimIdle, MAGE.SwimIdle)
...
local function TYEZAU_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.levitar.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local function aplicarAnimacao()
		...
		-- IDLE
		animate.idle.Animation1.AnimationId = LEVITATION.Idle1
		animate.idle.Animation2.AnimationId = LEVITATION.Idle2
	
		-- MOVIMENTO
		animate.walk.WalkAnim.AnimationId = LEVITATION.Walk
		animate.run.RunAnim.AnimationId = LEVITATION.Run
	
		-- PULO / QUEDA
		animate.jump.JumpAnim.AnimationId = LEVITATION.Jump
		animate.fall.FallAnim.AnimationId = LEVITATION.Fall
	
		-- ESCALAR
		animate.climb.ClimbAnim.AnimationId = LEVITATION.Climb
	
		-- NADAR
		animate.swim.Swim.AnimationId = LEVITATION.Swim
		animate.swimidle.SwimIdle.AnimationId = LEVITATION.SwimIdle
...
local function DVAZ_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.cartoon.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local function aplicarAnimacao()
		...
		-- IDLE
		animate.idle.Animation1.AnimationId = CARTOONY.Idle1
		animate.idle.Animation2.AnimationId = CARTOONY.Idle2
	
		-- MOVIMENTO
		animate.walk.WalkAnim.AnimationId = CARTOONY.Walk
		animate.run.RunAnim.AnimationId = CARTOONY.Run
	
		-- PULO / QUEDA
		animate.jump.JumpAnim.AnimationId = CARTOONY.Jump
		animate.fall.FallAnim.AnimationId = CARTOONY.Fall
	
		-- ESCALAR
		animate.climb.ClimbAnim.AnimationId = CARTOONY.Climb
	
		-- NADAR
		animate.swim.Swim.AnimationId = CARTOONY.Swim
		animate.swimidle.SwimIdle.AnimationId = CARTOONY.SwimIdle
...
local function OBEHUPN_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.amazon.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local function aplicarAnimacao()
		...
		-- IDLE
		setAnim(animate.idle.Animation1, AMAZON.Idle1)
		setAnim(animate.idle.Animation2, AMAZON.Idle2)
	
		-- MOVIMENTO
		setAnim(animate.walk.WalkAnim, AMAZON.Walk)
		setAnim(animate.run.RunAnim, AMAZON.Run)
	
		-- PULO / QUEDA
		setAnim(animate.jump.JumpAnim, AMAZON.Jump)
		setAnim(animate.fall.FallAnim, AMAZON.Fall)
	
		-- ESCALAR
		setAnim(animate.climb.ClimbAnim, AMAZON.Climb)
	
		-- NADAR
		setAnim(animate.swim.Swim, AMAZON.Swim)
		setAnim(animate.swimidle.SwimIdle, AMAZON.SwimIdle)
...
local function AHVJY_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.astronauta.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local function aplicarAnimacao()
		...
		-- IDLE
		setAnim(animate.idle.Animation1, ASTRONAUT.Idle1)
		setAnim(animate.idle.Animation2, ASTRONAUT.Idle2)
	
		-- MOVIMENTO
		setAnim(animate.walk.WalkAnim, ASTRONAUT.Walk)
		setAnim(animate.run.RunAnim, ASTRONAUT.Run)
	
		-- PULO / QUEDA
		setAnim(animate.jump.JumpAnim, ASTRONAUT.Jump)
		setAnim(animate.fall.FallAnim, ASTRONAUT.Fall)
	
		-- ESCALAR
		setAnim(animate.climb.ClimbAnim, ASTRONAUT.Climb)
	
		-- NADAR
		setAnim(animate.swim.Swim, ASTRONAUT.Swim)
		setAnim(animate.swimidle.SwimIdle, ASTRONAUT.SwimIdle)
...
local function USUH_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.antiga.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local OLDSCHOOL = {
		...
		Swim = "rbxassetid://5319852613",
		SwimIdle = "rbxassetid://5319850266"
	}
	...
	local function aplicarAnimacao()
		...
		setAnim(animate.idle.Animation1, OLDSCHOOL.Idle1)
		setAnim(animate.idle.Animation2, OLDSCHOOL.Idle2)
	
		setAnim(animate.walk.WalkAnim, OLDSCHOOL.Walk)
		setAnim(animate.run.RunAnim, OLDSCHOOL.Run)
	
		setAnim(animate.jump.JumpAnim, OLDSCHOOL.Jump)
		setAnim(animate.fall.FallAnim, OLDSCHOOL.Fall)
	
		setAnim(animate.climb.ClimbAnim, OLDSCHOOL.Climb)
	
		setAnim(animate.swim.Swim, OLDSCHOOL.Swim)
		setAnim(animate.swimidle.SwimIdle, OLDSCHOOL.SwimIdle)
...
local function SVAD_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.Estileira.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local function aplicarAnimacao()
		...
		setAnim(animate.idle.Animation1, STYLISH.Idle1)
		setAnim(animate.idle.Animation2, STYLISH.Idle2)
	
		setAnim(animate.walk.WalkAnim, STYLISH.Walk)
		setAnim(animate.run.RunAnim, STYLISH.Run)
	
		setAnim(animate.jump.JumpAnim, STYLISH.Jump)
		setAnim(animate.fall.FallAnim, STYLISH.Fall)
	
		setAnim(animate.climb.ClimbAnim, STYLISH.Climb)
	
		setAnim(animate.swim.Swim, STYLISH.Swim)
		setAnim(animate.swimidle.SwimIdle, STYLISH.SwimIdle)
...
local function JXIP_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.Robô.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local function aplicarAnimacao()
		...
		setAnim(animate.idle.Animation1, ROBOT.Idle1)
		setAnim(animate.idle.Animation2, ROBOT.Idle2)
	
		setAnim(animate.walk.WalkAnim, ROBOT.Walk)
		setAnim(animate.run.RunAnim, ROBOT.Run)
	
		setAnim(animate.jump.JumpAnim, ROBOT.Jump)
		setAnim(animate.fall.FallAnim, ROBOT.Fall)
	
		setAnim(animate.climb.ClimbAnim, ROBOT.Climb)
	
		setAnim(animate.swim.Swim, ROBOT.Swim)
		setAnim(animate.swimidle.SwimIdle, ROBOT.SwimIdle)
...
local function BTCVD_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.Elf.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local BOLD = {
		Idle1 = "rbxassetid://16744209868",
		Idle2 = "rbxassetid://16744209868",
	
		Walk = "rbxassetid://16744219182",
		Run = "rbxassetid://16744215691",
	
		Jump = "rbxassetid://16744213231",
		Fall = "rbxassetid://16744210857",
	
		Climb = "rbxassetid://16744212581",
	
		Swim = "rbxassetid://16744217089",
		SwimIdle = "rbxassetid://16744217089"
	}
	...
	local function aplicarAnimacao()
		...
		setAnim(animate.idle.Animation1, BOLD.Idle1)
		setAnim(animate.idle.Animation2, BOLD.Idle2)
	
		setAnim(animate.walk.WalkAnim, BOLD.Walk)
		setAnim(animate.run.RunAnim, BOLD.Run)
	
		setAnim(animate.jump.JumpAnim, BOLD.Jump)
		setAnim(animate.fall.FallAnim, BOLD.Fall)
	
		setAnim(animate.climb.ClimbAnim, BOLD.Climb)
	
		setAnim(animate.swim.Swim, BOLD.Swim)
		setAnim(animate.swimidle.SwimIdle, BOLD.SwimIdle)
...
local function ODOWKT_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.Velho.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	-- ELDER / ANCIÃO ANIMATION PACK
	local ELDER = {
		Idle1 = "rbxassetid://845397899",
		Idle2 = "rbxassetid://845400520",
	
		Walk = "rbxassetid://892267099",
	...
	local function aplicarAnimacao()
		...
		-- IDLE
		setAnim(animate.idle.Animation1, ELDER.Idle1)
		setAnim(animate.idle.Animation2, ELDER.Idle2)
	
		-- MOVIMENTO
		setAnim(animate.walk.WalkAnim, ELDER.Walk)
		setAnim(animate.run.RunAnim, ELDER.Run)
	
		-- PULO / QUEDA
		setAnim(animate.jump.JumpAnim, ELDER.Jump)
		setAnim(animate.fall.FallAnim, ELDER.Fall)
	
		-- ESCALAR
		setAnim(animate.climb.ClimbAnim, ELDER.Climb)
	
		-- NADAR
		setAnim(animate.swim.Swim, ELDER.Swim)
		setAnim(animate.swimidle.SwimIdle, ELDER.SwimIdle)
...
local function PMTM_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.Walmart.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	local function aplicarAnimacao()
		...
		setAnim(animate.idle.Animation1, NOBOUNDARIES.Idle1)
		setAnim(animate.idle.Animation2, NOBOUNDARIES.Idle2)
	
		setAnim(animate.walk.WalkAnim, NOBOUNDARIES.Walk)
		setAnim(animate.run.RunAnim, NOBOUNDARIES.Run)
	
		setAnim(animate.jump.JumpAnim, NOBOUNDARIES.Jump)
		setAnim(animate.fall.FallAnim, NOBOUNDARIES.Fall)
	
		setAnim(animate.climb.ClimbAnim, NOBOUNDARIES.Climb)
	
		setAnim(animate.swim.Swim, NOBOUNDARIES.Swim)
		setAnim(animate.swimidle.SwimIdle, NOBOUNDARIES.SwimIdle)
...
local function YUME_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.malvada.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function XQEX_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.Brinquedo.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	-- TOY ANIMATION PACK
	-- IDs confirmados pela documentação oficial do Roblox
	local TOY = {
	...
	local function aplicarAnimacao()
		...
		-- IDLE
		setAnim(animate.idle.Animation1, TOY.Idle1)
		setAnim(animate.idle.Animation2, TOY.Idle2)
	
		-- MOVIMENTO
		setAnim(animate.walk.WalkAnim, TOY.Walk)
		setAnim(animate.run.RunAnim, TOY.Run)
	
		-- PULO / QUEDA
		setAnim(animate.jump.JumpAnim, TOY.Jump)
		setAnim(animate.fall.FallAnim, TOY.Fall)
	
		-- ESCALAR
		setAnim(animate.climb.ClimbAnim, TOY.Climb)
	
		-- NADAR
		setAnim(animate.swim.Swim, TOY.Swim)
		setAnim(animate.swimidle.SwimIdle, TOY.SwimIdle)
...
local function CJWUG_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.superhero.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function VOOE_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.Through Life.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function ALDYV_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.superhero.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function OGDUZFN_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.Glow.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function HORW_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.animações.superhero.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function YRXPFSW_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.stalker.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function DEXBR_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.stalker.TpButton.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function NJSWAZ_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.stalker.verButton.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
...
local function PLRDM_fake_script() -- Fake Script: StarterGui.ScreenGui.mainFrame.stalker.syncButton.LocalScript
    local script = Instance.new("LocalScript")
    script.Name = "LocalScript"
	...
	button.MouseButton1Click:Connect(function()
		local target = getPlayerByName(nameBox.Text)
	
		if not target then
			warn("Player não encontrado:", nameBox.Text)
			return
		end
...
coroutine.wrap(PSQGNHV_fake_script)()
coroutine.wrap(HRBNO_fake_script)()
coroutine.wrap(EJFYIQ_fake_script)()
coroutine.wrap(HEOB_fake_script)()
coroutine.wrap(NMOCBK_fake_script)()
coroutine.wrap(ZSAY_fake_script)()
coroutine.wrap(HNJKFF_fake_script)()
coroutine.wrap(WBFQWZ_fake_script)()
coroutine.wrap(YXMBVRK_fake_script)()
coroutine.wrap(HDGMKO_fake_script)()
coroutine.wrap(XMBS_fake_script)()
coroutine.wrap(RZZYK_fake_script)()
coroutine.wrap(RSTPED_fake_script)()
coroutine.wrap(UFZEOU_fake_script)()
coroutine.wrap(SAPQIN_fake_script)()
coroutine.wrap(SBAIQK_fake_script)()
coroutine.wrap(JZWQ_fake_script)()
coroutine.wrap(KCDM_fake_script)()
coroutine.wrap(PTNVS_fake_script)()
coroutine.wrap(WHXTO_fake_script)()
coroutine.wrap(NPMUIZR_fake_script)()
coroutine.wrap(TYEZAU_fake_script)()
coroutine.wrap(DVAZ_fake_script)()
coroutine.wrap(OBEHUPN_fake_script)()
coroutine.wrap(AHVJY_fake_script)()
coroutine.wrap(USUH_fake_script)()
coroutine.wrap(SVAD_fake_script)()
coroutine.wrap(JXIP_fake_script)()
coroutine.wrap(BTCVD_fake_script)()
coroutine.wrap(ODOWKT_fake_script)()
coroutine.wrap(PMTM_fake_script)()
coroutine.wrap(YUME_fake_script)()
coroutine.wrap(XQEX_fake_script)()
coroutine.wrap(CJWUG_fake_script)()
coroutine.wrap(VOOE_fake_script)()
coroutine.wrap(ALDYV_fake_script)()
coroutine.wrap(OGDUZFN_fake_script)()
coroutine.wrap(HORW_fake_script)()
coroutine.wrap(YRXPFSW_fake_script)()
coroutine.wrap(DEXBR_fake_script)()
coroutine.wrap(NJSWAZ_fake_script)()
coroutine.wrap(PLRDM_fake_script)()
